...
model = T5ForConditionalGeneration.from_pretrained(r'D:\Demo\SC_checking\content\checkpoint-18500')
tokenizer = AutoTokenizer.from_pretrained(r'D:\Demo\SC_checking\content\checkpoint-18500')
global SPECIAL
SPECIAL =[]
